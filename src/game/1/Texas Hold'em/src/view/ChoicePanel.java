...
public class ChoicePanel extends JPanel{
	...
	public ChoicePanel(Table table, GameArea view){
		...
		checkListener checkListener = new checkListener(table,view);
		check.addActionListener(checkListener);
		
		ActionListener foldListener = new foldListener(view);
		fold.addActionListener(foldListener);
		
		ActionListener betListener = new betListener(view, this);
		bet.addActionListener(betListener);
		slider.addChangeListener((ChangeListener) betListener);
