...
public class PlayCard {
	...
	private String imgPath; // the path to the card face in /images
        private String imgPathFlipped = "/brooklynbridgepokerfxml/images/cards/b2fv.png"; // path to the image of a card back in /images
	...
	public char getSuit(){  // gets the card suit
        ...
        public void setImage(String image){ //sets the image path (could be improved)
            this.image="/brooklynbridgepokerfxml/images/cards/"+image+".png";
        }
